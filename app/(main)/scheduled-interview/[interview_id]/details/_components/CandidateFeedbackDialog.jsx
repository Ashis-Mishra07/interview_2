                        ...
                        <div className='mt-5 '>
                            <div className='flex justify-between items-center'>
                                ...
                                <div className='flex gap-3 items-center'>
                                    <h2 className='text-primary text-2xl font-bold'>5/10</h2>
                                </div>
                            </div>
                            <div className='mt-5'>
                            ...
                            <div className='mt-5'>
                                ...
                                <div className='p-5 bg-secondary mt-3 rounded-md'>
                                    {feedback?.summary?.split('. ').map((line, index) => (
                            ...
                            <div className={`p-5 mt-10 flex items-center justify-between rounded-md ${feedback?.Recommendation=='No'?'bg-red-100':'bg-green-100'} `}>
                                ...
                                <Button className={`${feedback?.Recommendation == 'No' ? 'bg-red-700' : 'bg-green-700'}`} >
                                    Send Msg
                                </Button>
                            </div>
                        </div>
