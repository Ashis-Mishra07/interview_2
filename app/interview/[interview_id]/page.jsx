  ...
  return (
    <div className='px-10 md:px-28 lg:px-48 xl:px-80 mt-7 '>
          <div className='flex flex-col items-center justify-center border rounded-lg bg-white p-7 lg:px-33 xl:px-52 mb-20'>
            ...
            <Image src={'/interview.png'} alt='interview' width={600} height={600} className='w-[280px] my-6'/>
            ...
            <div  className='w-full'>
                ...
                <Input placeholder='e.g. Ashis Mishra' onChange={(event)=>setUserName(event.target.value)}/>
            </div>
              <div className='w-full'>
                  <h2>Enter Your Email</h2>
                  <Input placeholder='e.g. mishraashis07@gmail.com' onChange={(event) => setUserEmail(event.target.value)} />
              </div>
            ...
            <Button disabled={loading || !userName} onClick={()=>onJoinInterview()}  className='mt-5 w-full font-bold'> <Video/>{loading&&<Loader2Icon/>} Join Interview</Button>
        </div>
    </div>
  )
}
